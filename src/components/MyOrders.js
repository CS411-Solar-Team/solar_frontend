      ...
      <List
        ...
        renderItem={(item) => (
            ...
            <List.Item.Meta
              ...
              description={
                <>
                  <Text><strong>Estimate Delivered Time: {item.bill_number}</strong></Text>
                  <br />
                  <Text><strong>Delivery Address: {item.saving}</strong></Text>
                  <br />
                  <Text><strong>Delivery Price: ${item.user_address}</strong></Text>
                </>
              }
